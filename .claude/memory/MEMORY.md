...
- [Pre-deployment TODO](pre-deployment-todo.md) — local-only, gitignored (unfixed holes): 12 framework security/hardening findings verified against this repo 2026-08-26, blockers first; written and re-checked by the `predeploy-audit` skill
