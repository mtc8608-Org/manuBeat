...
- [Deployment plan](deployment-plan.md) — local-only, gitignored (personal infra): Hetzner hosting decisions, provisioned infra walkthrough, self-test commands, and the settled per-app-stacks + Caddy design awaiting implementation
