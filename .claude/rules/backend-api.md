...
> Port status: the tier/roles auth model below is the target state, flagged in manuHunter and being ported here — see `.claude/memory/framework-upstream-candidates.md` for what has landed.
